...
<div class="container mt-5">
    ...
    <p>Welcome to your user profile page, {{ $name }} (ID: {{ $id }}).</p>

    <!-- Konten khusus untuk halaman user profile -->
    <!-- Anda dapat menambahkan formulir atau informasi pengguna lainnya di sini -->
</div>
